...
export default function Dashboard() {
  return (
    <div className="min-h-screen bg-[#faf9f7] text-[#1a1a2e]">

      {/* HEADER */}
      <header className="bg-[#1a1a2e] text-white px-4 sm:px-6 md:px-10 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <h1 className="text-lg sm:text-xl md:text-2xl font-[var(--font-playfair)] text-center sm:text-left">
          Hansonium Agentic OS
        </h1>

        <div className="flex justify-center sm:justify-end flex-wrap items-center gap-3 text-xs sm:text-sm">
          <span className="bg-[#4ade80] text-[#1a1a2e] px-3 py-1 rounded-full font-semibold">
            CEO
          </span>
      ...
      <main className="px-4 sm:px-6 md:px-10 py-6 sm:py-8 space-y-10">
        ...
        <section className="bg-white rounded-2xl border border-[#e8e4dd] p-4 sm:p-6 md:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <Link
              href="/non-compliant"
              className="bg-[#1a1a2e] text-white px-4 py-2 rounded-lg text-sm w-full sm:w-auto text-center"
            >
              View Non-Compliant
            </Link>
          </div>
